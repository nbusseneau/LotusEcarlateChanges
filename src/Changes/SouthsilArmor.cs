...
public class SouthsilArmor : ReflectionChangesBase<SouthsilArmorPlugin>
{
  protected override void ApplyChangesInternal()
  {
    ...
    chieftainHelmBoar.RequiredItems.Add("FoxPelt_TW", 2);
    ...
    chieftainHelmBoar.RequiredUpgradeItems.Add("FoxPelt_TW", 1);
    ...
    chieftainHelmDeer.RequiredUpgradeItems.Add("FoxPelt_TW", 1);
    ...
    chieftainChest.RequiredItems.Add("FoxPelt_TW", 6);
    ...
    chieftainChest.RequiredUpgradeItems.Add("FoxPelt_TW", 3);
    ...
    chieftainLegs.RequiredItems.Add("FoxPelt_TW", 4);
    ...
    chieftainLegs.RequiredUpgradeItems.Add("FoxPelt_TW", 2);
    ...
    battleswineHelm.RequiredItems.Add("RazorbackLeather_TW", 6);
    battleswineHelm.RequiredItems.Add("BlackBearPelt_TW", 2);
    ...
    battleswineHelm.RequiredUpgradeItems.Add("RazorbackLeather_TW", 2);
    battleswineHelm.RequiredUpgradeItems.Add("BlackBearPelt_TW", 1);
    ...
    battleswineChest.RequiredItems.Add("Bronze", 6);
    battleswineChest.RequiredItems.Add("RazorbackLeather_TW", 6);
    battleswineChest.RequiredItems.Add("BlackBearPelt_TW", 2);
    battleswineChest.RequiredItems.Add("TrophyRazorback_TW", 2);
    battleswineChest.RequiredUpgradeItems.Clear();
    battleswineChest.RequiredUpgradeItems.Add("Bronze", 3);
    battleswineChest.RequiredUpgradeItems.Add("RazorbackLeather_TW", 2);
    ...
    battleswineLegs.RequiredItems.Add("Bronze", 4);
    battleswineLegs.RequiredItems.Add("RazorbackLeather_TW", 6);
    battleswineLegs.RequiredItems.Add("BlackBearPelt_TW", 2);
    battleswineLegs.RequiredUpgradeItems.Clear();
    battleswineLegs.RequiredUpgradeItems.Add("Bronze", 2);
    battleswineLegs.RequiredUpgradeItems.Add("RazorbackLeather_TW", 2);
    battleswineLegs.RequiredUpgradeItems.Add("BlackBearPelt_TW", 1);
    ...
    draugrHelm.RequiredItems.Add("RottenPelt_TW", 4);
    draugrHelm.RequiredItems.Add("WitheredBone", 2);
    draugrHelm.RequiredItems.Add("TrophyCrawler_TW", 2);
    ...
    draugrChest.RequiredItems.Add("RottenPelt_TW", 8);
    ...
    draugrLegs.RequiredItems.Add("RottenPelt_TW", 6);
    ...
    draugrLegs.RequiredUpgradeItems.Add("RottenPelt_TW", 2);
    ...
    grizzlyHelm.RequiredItems.Add("GrizzlyBearPelt_TW", 2);
    ...
    grizzlyHelm.RequiredUpgradeItems.Add("GrizzlyBearPelt_TW", 1);
    ...
    grizzlyChest.RequiredItems.Add("GrizzlyBearPelt_TW", 6);
    ...
    grizzlyChest.RequiredUpgradeItems.Add("Silver", 6);
    grizzlyChest.RequiredUpgradeItems.Add("GrizzlyBearPelt_TW", 3);
    ...
    grizzlyLegs.RequiredItems.Add("GrizzlyBearPelt_TW", 4);
    ...
    grizzlyLegs.RequiredUpgradeItems.Add("Silver", 3);
    grizzlyLegs.RequiredUpgradeItems.Add("GrizzlyBearPelt_TW", 2);
