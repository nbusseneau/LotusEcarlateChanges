...
public class SouthsilArmor : StandaloneManagerBasedChangesBase
{
  ...
  protected override void ApplyInternal()
  {
    ...
    jormungandrHelm.RequiredItems.Add("FlametalNew", 15);
    ...
    jormungandrHelm.RequiredUpgradeItems.Add("FlametalNew", 7);
    ...
    jormungandrChest.RequiredItems.Add("FlametalNew", 45);
    ...
    jormungandrChest.RequiredUpgradeItems.Add("FlametalNew", 22);
    ...
    jormungandrLegs.RequiredItems.Add("FlametalNew", 30);
    ...
    jormungandrLegs.RequiredUpgradeItems.Add("FlametalNew", 15);
    ...
    morgenslayerHelm.RequiredItems.Add("FlametalNew", 15);
    ...
    morgenslayerHelm.RequiredUpgradeItems.Add("FlametalNew", 7);
    ...
    morgenslayerChest.RequiredItems.Add("FlametalNew", 45);
    ...
    morgenslayerChest.RequiredUpgradeItems.Add("FlametalNew", 22);
    ...
    morgenslayerLegs.RequiredItems.Add("FlametalNew", 30);
    ...
    morgenslayerLegs.RequiredUpgradeItems.Add("FlametalNew", 15);
