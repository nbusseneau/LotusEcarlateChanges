...
- Fix flametal-based armor recipes because I'm dumb.

## [0.7.4] - 2025-08-06

### Fixed

- Fix trophies in new Ashlands-tier armor recipes.

## [0.7.3] - 2025-08-06

### Changed

- Adjust comfort / container sizes / cost on various pieces.

## [0.7.2] - 2025-08-05

### Changed

- Allow crafting flint arrows with level 1 workbench since we disabled wood arrows.

## [0.7.1] - 2025-08-05

### Added

- Re-add MaxAxe dependency (oops).
...
- FallDamageForCreatures: add Seeker Brood and Tick to ignore list.
...
- Set Longship storage size back to its vanilla value of 18.

## [0.6.38] - 2024-07-19

### Fixed

- Fix Balrond Containers comfort values (for real this time).
...
[unreleased]: https://github.com/nbusseneau/LotusEcarlateChanges/compare/0.7.4...HEAD
...
[0.7.2]: https://github.com/nbusseneau/LotusEcarlateChanges/compare/0.7.1...0.7.2
[0.7.1]: https://github.com/nbusseneau/LotusEcarlateChanges/compare/0.7.0...0.7.1
[0.7.0]: https://github.com/nbusseneau/LotusEcarlateChanges/compare/0.6.46...0.7.0
